...
/**
 * Arguments for the Cause query
 */
export type CauseArguments = {
    /**
     * The ID of the Cause to fetch
     */
    id: string

    /**
     * The locale of the Cause to fetch.
     */
    locale: Locale
}

/**
 * Arguments for the Paginated Cause query
 */
export type PaginatedCauseArguments = {
    /**
     * The locale of the Cause to fetch.
     */
    locale: Locale
